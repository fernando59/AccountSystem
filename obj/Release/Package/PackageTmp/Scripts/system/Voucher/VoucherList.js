            ...
            },
            {
                "render": function (row, type, set) {
                    ...
                    return `<div class="text-center">
                        <a class="btn  btn-primary  btn-sm"   data-toggle="tooltip" data-placement="top" title="Reporte de Comprobante" href="http://192.168.100.8/Report/report/Report%20Account/ReportVoucher?idVoucher=${id}"  target="_blank"><span class="glyphicon glyphicon-check" aria-hidden="true"><i class="fas fa-book"></i></span></a>
